...
$actions['duplicate'] = '<a href="' . wp_nonce_url('admin.php?action=rd_duplicate_page_as_draft&post=' . $post->ID,
		basename(__FILE__), 'duplicate_nonce' ) . '" title="Duplicate this item" rel="permalink">Duplicate</a>';
}
return $actions;
}
